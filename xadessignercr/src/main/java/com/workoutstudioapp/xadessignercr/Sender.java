...
public class Sender {
	...
	public void send_nota_debito(String endpoint, String xmlPath, String username, String password) {
		try {			
			XPath xPath = XPathFactory.newInstance().newXPath();
			File file = new File(xmlPath);
			byte[] bytes = FileUtils.readFileToString(file, "UTF-8").getBytes("UTF-8");
			...
			Document xml = XmlHelper.getDocument(xmlPath);
			NodeList nodes = (NodeList) xPath.evaluate("/NotaDebitoElectronica/Clave", xml.getDocumentElement(), XPathConstants.NODESET);
			comprobanteElectronico.setClave(nodes.item(0).getTextContent());
			...
			ObligadoTributario receptor = new ObligadoTributario();
			ObligadoTributario emisor = new ObligadoTributario();
			nodes = (NodeList) xPath.evaluate("/NotaDebitoElectronica/Emisor/Identificacion/Tipo", xml.getDocumentElement(), XPathConstants.NODESET);
			emisor.setTipoIdentificacion(nodes.item(0).getTextContent());
			nodes = (NodeList) xPath.evaluate("/NotaDebitoElectronica/Emisor/Identificacion/Numero", xml.getDocumentElement(), XPathConstants.NODESET);
			emisor.setNumeroIdentificacion(nodes.item(0).getTextContent());
			
			nodes = (NodeList) xPath.evaluate("/NotaDebitoElectronica/Receptor/Identificacion/Tipo", xml.getDocumentElement(), XPathConstants.NODESET);
			receptor.setTipoIdentificacion(nodes.item(0).getTextContent());
			nodes = (NodeList) xPath.evaluate("/NotaDebitoElectronica/Receptor/Identificacion/Numero", xml.getDocumentElement(), XPathConstants.NODESET);
			receptor.setNumeroIdentificacion(nodes.item(0).getTextContent());
	...
	public void send_tiquete(String endpoint, String xmlPath, String username, String password) {
		try {			
			XPath xPath = XPathFactory.newInstance().newXPath();
			File file = new File(xmlPath);
			byte[] bytes = FileUtils.readFileToString(file, "UTF-8").getBytes("UTF-8");
			...
			Document xml = XmlHelper.getDocument(xmlPath);
			NodeList nodes = (NodeList) xPath.evaluate("/TiqueteElectronico/Clave", xml.getDocumentElement(), XPathConstants.NODESET);
			comprobanteElectronico.setClave(nodes.item(0).getTextContent());
			...
			emisor.setTipoIdentificacion(nodes.item(0).getTextContent());
			nodes = (NodeList) xPath.evaluate("/TiqueteElectronico/Emisor/Identificacion/Numero", xml.getDocumentElement(), XPathConstants.NODESET);
			emisor.setNumeroIdentificacion(nodes.item(0).getTextContent());
			
			nodes = (NodeList) xPath.evaluate("/TiqueteElectronico/Receptor/Identificacion/Tipo", xml.getDocumentElement(), XPathConstants.NODESET);
			receptor.setTipoIdentificacion(nodes.item(0).getTextContent());
			nodes = (NodeList) xPath.evaluate("/TiqueteElectronico/Receptor/Identificacion/Numero", xml.getDocumentElement(), XPathConstants.NODESET);
			receptor.setNumeroIdentificacion(nodes.item(0).getTextContent());
